...
const ChatBot = () => {
  ...
  const [currentOptions, setCurrentOptions] = useState([
    { id: 1, text: "How to play Sudoku?", response: "Sudoku is played on a grid of 9 x 9 spaces. Each row, column, and square (9 spaces each) must contain all numbers 1-9 without repetition." },
    { id: 2, text: "Help with a puzzle", response: "Sure, please provide the puzzle or describe the issue!" },
    { id: 3, text: "Other games", response: "We also offer tips and tricks for other puzzles like crosswords and logic grids!" }
  ]);
