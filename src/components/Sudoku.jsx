...
const SudokuSolver = () => {
  ...
  // Sudoku solving logic (backtracking algorithm)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-gray-100 dark:bg-gray-900">
      ...
      <button
        onClick={handleSolve}
        className="mt-4 px-4 py-2 bg-blue-500 dark:bg-blue-700 text-white font-semibold rounded-lg shadow-md hover:bg-blue-700 dark:hover:bg-blue-800"
      >
        Solve Sudoku
      </button>
    </div>
